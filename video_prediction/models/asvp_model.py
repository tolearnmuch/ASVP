...
def discriminator_fn(inputs, inputs_major, inputs_inferior, outputs, mode, hparams):
...
class ASVPVideoPredictionModel(VideoPredictionModel):
    def __init__(self, *args, **kwargs):
        super(ASVPVideoPredictionModel, self).__init__(
    ...
    def get_default_hparams_dict(self):
        default_hparams = super(ASVPVideoPredictionModel, self).get_default_hparams_dict()
        hparams = dict(
            l1_weight=1.0,
            l2_weight=0.0,
            n_layers=3,
    ...
    def parse_hparams(self, hparams_dict, hparams):
        ...
        return super(ASVPVideoPredictionModel, self).parse_hparams(hparams_dict, hparams)
    ...
    def restore(self, sess, checkpoints, restore_to_checkpoint_mapping=None):
        ...
        super(ASVPVideoPredictionModel, self).restore(sess, checkpoints, restore_to_checkpoint_mapping)
